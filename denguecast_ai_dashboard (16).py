...
translations = {
    ...
    "Français 🇫🇷": {
        ...
        "policy_3": "Alertes de mobilité (-15% transmission)",
...
with tabs[0]:
    ...
    with col_dashboard_lights:
        ...
        # Calculates glowing inline styling depending on active status levels
        stable_shadow = "box-shadow: 0 0 25px 5px rgba(0, 245, 160, 0.85);" if risk_level == "STABLE" else "opacity: 0.15;"
        escalating_shadow = "box-shadow: 0 0 25px 5px rgba(255, 208, 0, 0.85);" if risk_level == "ESCALATING" else "opacity: 0.15;"
        critical_shadow = "box-shadow: 0 0 25px 5px rgba(255, 46, 147, 0.85);" if risk_level == "CRITICAL" else "opacity: 0.15;"
