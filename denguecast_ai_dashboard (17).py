...
# Custom premium CSS styling for modern, high-contrast, Apple-inspired dark mode
st.markdown("""
...
# ==============================================================================
# PHASE 2: GLOBAL CONFIGURATIONS & COMPREHENSIVE TRANSLATION ARRAYS
# ==============================================================================
translations = {
    "English 🇬🇧": {
        "title": "GA1A",
    ...
    "简体中文 🇨🇳": {
        ...
        "btn_sat": "📡 调度 Sentinel-2 卫星多光谱光谱扫描",
...
# ==============================================================================
# PHASE 3: UTILITY MATHEMATICAL & TELEMETRIC DATA PACKET SOLVERS
# ==============================================================================
...
# ==============================================================================
# PHASE 4: RENDER APPLE-INSPIRED TOP MARGIN BAR & GEOGRAPHIC LOGISTICS
# ==============================================================================
...
# ==============================================================================
# PHASE 5: SIDEBAR GEOLOCATION INGESTION CONTROL ENGINE
# ==============================================================================
...
# Dynamic selectbox loads immediately from current geocoded queries
...
# --- 5.5 ADAPTIVE CURRENCY & HOTLINE SYSTEM (GEOGRAPHIC SPECIFICS) ---
...
# ==============================================================================
# PHASE 6: ATMOSPHERIC MODEL SLIDERS & SENSORS TELEMETRY INGESTION
# ==============================================================================
...
# Call Open-Meteo live API to extract real time weather based on selected target coordinates
...
# Satellite Data Export Channel (Using current parameters) - resolved NameError by passing explicitly
...
# --- 6.5 SYSTEM ACCESS MONITOR (VISITOR COUNTER) ---
...
# ==============================================================================
# PHASE 7: MATHEMATICAL OUTBREAK MODEL SOLVER
# ==============================================================================
...
if final_risk_score >= 70:
    ...
    stable_shadow = "opacity: 0.15;"
    escalating_shadow = "opacity: 0.15;"
    critical_shadow = "box-shadow: 0 0 25px 5px rgba(255, 46, 147, 0.85);"
elif final_risk_score >= 40:
    risk_level = "ESCALATING"
    risk_color = "#ffd000"
    risk_bg = "rgba(255, 208, 0, 0.15)"
    stable_shadow = "opacity: 0.15;"
    escalating_shadow = "box-shadow: 0 0 25px 5px rgba(255, 208, 0, 0.85);"
    critical_shadow = "opacity: 0.15;"
else:
    risk_level = "STABLE"
    risk_color = "#00f5a0"
    risk_bg = "rgba(0, 245, 160, 0.15)"
    stable_shadow = "box-shadow: 0 0 25px 5px rgba(0, 245, 160, 0.85);"
    escalating_shadow = "opacity: 0.15;"
    critical_shadow = "opacity: 0.15;"
...
# ==============================================================================
# PHASE 8: DYNAMIC INTERACTIVE APP WORKSPACE
# ==============================================================================
tabs = st.tabs([
    lang['tab_map'], 
    lang['tab_sim'], 
...
with tabs[0]:
    ...
    with col_map_layer_ctrl:
        map_layer_view = st.radio(
            ...
            options=["🔴 Current Outbreak Zones", "🔮 Predictive Hotspots (14-Day Spread Forecast)", "🛰️ Multi-Layer Consolidated View"],
            horizontal=True,
    ...
    with col_map_render:
        ...
        for idx, row in combined_map_df.iterrows():
            ...
            if map_layer_view in ["🔮 Predictive Hotspots (14-Day Spread Forecast)", "🛰️ Multi-Layer Consolidated View"]:
    ...
    with col_dashboard_lights:
        ...
        <div style="background: rgba(15, 23, 42, 0.55); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 24px; text-align: center; min-height: 400px; display: flex; flex-direction: column; justify-content: space-around;">
            <div>
                ...
                <!-- Red Critical LED -->
                <div style="margin: 15px auto; width: 45px; height: 45px; border-radius: 50%; background-color: #ff2e93; transition: all 0.3s; {critical_shadow}"></div>
                
                <!-- Yellow Escalating LED -->
                <div style="margin: 15px auto; width: 45px; height: 45px; border-radius: 50%; background-color: #ffd000; transition: all 0.3s; {escalating_shadow}"></div>
                
                <!-- Green Stable LED -->
                <div style="margin: 15px auto; width: 45px; height: 45px; border-radius: 50%; background-color: #00f5a0; transition: all 0.3s; {stable_shadow}"></div>
            </div>
