...
translations = {
    ...
    "Español 🇪🇸": {
        ...
        "search_help": "Busque cualquier ubicación global (p. ej., Kuala Lumpur, Okinawa, Perak, Londres) para actualizar mapas y datos.",
        "pathology": "DISEASES",
        "timeline": "FECHA",
        "telemetry": "CLIMATE SENSORS",
        ...
        "mobility_label": "Factor de Proximidad del Vector",
        "export_btn": "📥 Descargar Conjunto de Datos",
        ...
        "map_style": "🗺️ Estilo de Capa del Mapa:",
        ...
        "policy_1": "Aplicar Larvicidas Químicos (-40% carga de casos)",
        "policy_2": "Movilizar Limpieza Comunitaria (-25% zonas de cría)",
        "policy_3": "Emitir Alertas de Movilidad (-15% transmisión)",
        "baseline_label": "PREDICCIÓN BASE (SIN MITIGACIÓN):",
        "projected_label": "CASOS PROYECTADOS MITIGADOS:",
        "prevented_label": "+ TOTAL DE INGRESOS EVITADOS:",
        "cases_unit": "CASOS",
        "patients_unit": "PACIENTES",
        "optimizer_header": "📋 Optimizador de Acciones Recomendadas",
        "memo_header": "📄 Memo de Información Ejecutiva",
        "download_memo": "📥 Descargar Memo (.txt)",
        "decision_header": "⚡ Consola de Mando",
        "btn_warn": "🚨 Transmitir Alerta a la App de Ciudadanos",
        "btn_scale": "🚑 Movilizar Protocolos de Camas de Emergencia",
        "btn_sat": "📡 Sincronizar Bandas Satelitales Sentinel-2",
        "citizen_form_header": "📸 Informe Ciudadano",
        "inc_name": "Nombre de la Ubicación",
        "inc_cat": "Categoría de Peligro Observada",
        "inc_obs": "Detalles del Incidente",
        "inc_upload": "Subir Foto / Video de Verificación",
        "inc_btn": "Verificar Informe y Actualizar Puntos Críticos",
        "active_feed": "Flujo de Informes Ciudadanos Verificados",
        "contact_title": "🤝 Colaborar con el Equipo GA1A",
        "contact_text": "Únase a la red global de administradores de salud pública, planificadores municipales y climatólogos que utilizan GA1A para desarrollar la resiliencia climática.",
        "sponsor_btn": "✉️ Contactar al Equipo GA1A"
    },
    "Français 🇫🇷": {
        "title": "GA1A",
        ...
        "search_help": "Recherchez n'importe quel lieu dans le monde (ex. Kuala Lumpur, Okinawa, Perak, Londres) pour mettre à jour la carte.",
        "pathology": "DISEASES",
        "timeline": "DATE",
        "telemetry": "CLIMATE SENSORS",
        ...
        "inspector_help": "Sélectionnez un nœud actif sur la carte pour interroger les paramètres :",
        ...
        "policy_1": "Appliquer des larvicides chimiques (-40% charge de cas)",
        "policy_2": "Mobiliser le nettoyage communautaire (-25% zones de reproduction)",
        "policy_3": "Émettre des alertes de mobilité (-15% transmission)",
        "baseline_label": "PRÉDICTION DE BASE (NON MITIGÉE) :",
        "projected_label": "CAS PROJETÉS MITIGÉS :",
        "prevented_label": "+ TOTAL DES HOSPITALISATIONS ÉVITÉES :",
        "cases_unit": "CAS",
        "patients_unit": "PATIENTS",
        "optimizer_header": "📋 Optimiseur d'Actions Recommandées",
        "memo_header": "📄 Mémo d'Information Exécutif",
        "download_memo": "📥 Télécharger le Mémo (.txt)",
        "decision_header": "⚡ Console de Commandement",
        "btn_warn": "🚨 Diffuser une Alerte sur l'App Citoyenne",
        "btn_scale": "🚑 Mobiliser les Protocoles de Lits d'Urgence",
        "btn_sat": "📡 Synchroniser les Bandes Satellite Sentinel-2",
        "citizen_form_header": "📸 Signalement Citoyen",
        "inc_name": "Nom du Lieu",
        "inc_cat": "Catégorie de Danger Observée",
        "inc_obs": "Détails de l'Incident",
        "inc_upload": "Téléverser Photo / Vidéo de Vérification",
        "inc_btn": "Vérifier le Rapport & Mettre à Jour",
        "active_feed": "Flux des Rapports Citoyens Vérifiés",
        "contact_title": "🤝 Collaborer avec l'Équipe GA1A",
        "contact_text": "Rejoignez le réseau mondial d'administrateurs de la santé publique, d'urbanistes et de climatologues qui utilisent GA1A pour renforcer la résilience climatique.",
        "sponsor_btn": "✉️ Contacter l'Équipe GA1A"
    },
    "简体中文 🇨🇳": {
        "title": "GA1A",
        "subtitle": "气候传染病跟踪系统",
...
st.markdown("""
<style>
    /* Premium High-End Glassmorphism Card Panels */
    .glass-card {
...
# Satellite Data Export Channel - passing active_location_name explicitly to bypass scoping NameError
...
with tabs[0]:
    ...
    # Active predictive logic banner to show data status clearly
    if is_future_model:
        st.markdown("""
